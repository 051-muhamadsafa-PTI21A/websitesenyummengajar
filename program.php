...
<body>
 ...
 <div class="container-fluid bg-primary pt-3 d-none d-lg-block">
    ...
    <div class="container-fluid p-5 my-2 bg-white text-center text-primary">
        ...
        <a href="program-1.php" class="btn btn-primary py-md-3 px-md-5 mt-2">Public Speaking</a
      >
      <a href="program-2.php" class="btn btn-primary py-md-3 px-md-5 mt-2"
        >English Class</a
      >
      <a href="program-3.php" class="btn btn-primary py-md-3 px-md-5 mt-2"
        >Pelatihan Mengajar bagi Calon Guru</a
      >
      <a href="program-4.php" class="btn btn-primary py-md-3 px-md-5 mt-2"
        >Pelatihan Digital Marketing</a
      >
      <a href="program-5.php" class="btn btn-primary py-md-3 px-md-5 mt-2">
        Pembekalan Menganai Kesehatan Mental</a
      >
    </div>
