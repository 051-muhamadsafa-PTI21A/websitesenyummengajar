...
if(isset($_POST["btn_p5"])){
  $nama_lengkap = $_POST["nama_5"];
  $usia = $_POST["usia_5"];
  $alamat = $_POST["alamat_5"];
  $email = $_POST["email_5"];
  $no_telpon = $_POST["notlp_5"];
 

  $query = "INSERT INTO program_5 VALUES('', '$nama_lengkap', '$usia', '$alamat', '$email', '$no_telpon')";
                ...
                <div class="text-center">
                    <div class="destination-item position-relative overflow-hidden mb-2">
                        <a class="destination-overlay text-dark text-decoration-none" href="">
                            <h5 class="text-dark">Pembekalan kesehatan Mental</h5>
                            <span>Dengan adanya kegiatan pembekalan ini diharapkan dapat meningkatkan tingkat kesadaraan masyarakat mengenai kesehatan mental.</span>
                        </a>
                    </div>
                </div>
            </div>
    ...
    <div class="container-fluid py-3 border-top">
        <div class="row">
            <div class="col-md-6">
                ...
                <p class="text-dark"> 13 April 2023</p>
                <p class="text-dark"> Pukul 08.00-12.00 WIB</p>
                <h5 class="bg-primary text-light"> DETAIL AKTIVITAS</h5>
                <li class="nav-item mb-2"><a>Pembekalan mengenai pentingnya kesehatan mental</a></li>
                <li class="nav-item mb-2"><a>Pelatihan deteksi dini gangguan jiwa</a></li>
            ...
            <div class="col-sm-6 bg-light">
                ...
                <form class="" action="" method="post" autocomplete="off">
                    <div class="form-group col-md-6">
                        ...
                        <input type="text" class="form-control" name="nama_5" required>
                    </div>
                    <div class="form-group col-md-6">
                        <label for="usia">Usia:</label>
                        <input type="text" class="form-control" name="usia_5" required>
                    </div>
                    <div class="form-group col-md-6">
                        <label for="alamat">Alamat:</label>
                        <input type="text" class="form-control" name="alamat_5" required>
                    </div>
                    <div class="form-group col-md-6">
                        <label for="email">Email:</label>
                        <input type="text" class="form-control" name="email_5" required>
                    </div>
                    <div class="form-group col-md-6">
                        <label for="notelp">No.Telepon:</label>
                        <input type="text" class="form-control" name="notlp_5" required>
                    </div>

                    <button class="btn btn-primary mt-2 mb-2" type="submit" name="btn_p5">Submit</button>
                </form>
            </div>
            <div class="col-sm-6 bg-default">
                <h5 class="text-light bg-primary">PEMBAYARAN</h5>
                <p class="text-dark"> Rp.400.000/Orang</p>
