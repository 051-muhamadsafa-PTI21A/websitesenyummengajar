...
if(isset($_POST["btn_v3"])){
  $nama_lengkap = $_POST["nama_3"];
  $usia = $_POST["usia_3"];
  $alamat = $_POST["alamat_3"];
  $email = $_POST["email_3"];
  $no_telpon = $_POST["notlp_3"];
  $pilih_bidang = $_POST["pilihan_3"];
 

  $query = "INSERT INTO volunteer_3 VALUES('', '$nama_lengkap', '$usia', '$alamat', '$email', '$no_telpon', '$pilih_bidang')";
            ...
            <input type="text" class="form-control" name="nama_3" required>
                ...
                <input type="text" class="form-control" name="usia_3" required>
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <select class="form-control" name="pilihan_3" required>
                    ...
                    <button class="btn btn-primary mt-2 mb-2" type="submit" name="btn_v3">Submit</button>
                </form>
            </div>
