...
if(isset($_POST["btn_v2"])){
  $nama_lengkap = $_POST["nama_2"];
  $usia = $_POST["usia_2"];
  $alamat = $_POST["alamat_2"];
  $email = $_POST["email_2"];
  $no_telpon = $_POST["notlp_2"];
  $pilih_bidang = $_POST["pilihan_2"];
 

  $query = "INSERT INTO volunteer_2 VALUES('', '$nama_lengkap', '$usia', '$alamat', '$email', '$no_telpon', '$pilih_bidang')";
                ...
                <div class="text-center">
                    <div class="destination-item position-relative overflow-hidden mb-2">
                        ...
                        <a class="destination-overlay text-dark text-decoration-none" href="">
                            <h5 class="text-dark">Peneleh Youth Volunteer Camp</h5>
    ...
    <div class="container-fluid py-3 border-top">
        <div class="row">
            <div class="col-md-6">
                ...
                <li class="nav-item mb-2"><a>Pemberian materi materi tentang Tata Krama</a></li>
                <li class="nav-item mb-2"><a>Pohon Harapan Masa Depan</a></li>
        ...
        <div class="row">
            <div class="col-sm-6 bg-light">
                ...
                <form class="" action="" method="post" autocomplete="off">
                    ...
                    <button class="btn btn-primary mt-2 mb-2" type="submit" name="btn_v2">Submit</button>
                </form>
            </div>
