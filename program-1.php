...
if(isset($_POST["btn_p1"])){
  ...
  $query = "INSERT INTO program_1 VALUES('', '$nama_lengkap', '$usia', '$alamat', '$email', '$no_telpon')";
...
<body>
 ...
 <div class="container-fluid bg-primary pt-3 d-none d-lg-block">
      ...
      <div class="container pt-5 pb-3">
        ...
        <div class="coloum">
          <div class="text-center">
            ...
            >
              <a
                class="destination-overlay text-dark text-decoration-none"
                href=""
              >
                <h5 class="text-dark">Pelatihan Public Speaking</h5>
                <span
                  >Pelatihan public speaking penting bagi siapa saja yang ingin
                  memperoleh keterampilan komunikasi yang efektif, seperti
                  manajer, pebisnis, pengajar, politisi, atau bahkan mahasiswa.
                  Dengan pelatihan yang tepat, seseorang dapat meningkatkan
                  kepercayaan diri dan kemampuan untuk berbicara di depan
                  publik.</span
                >
              </a>
                    </div>
    ...
    <div class="container-fluid py-3 border-top">
        <div class="row">
            <div class="col-md-6">
                ...
                <p class="text-dark">25-26 Desember 2023</p>
                <p class="text-dark">Pukul 08.00-11.00 WIB</p>
                <h5 class="bg-primary text-light">DETAIL AKTIVITAS</h5>
                <li class="nav-item mb-2">
                    <a>Pengenalan dasar-dasar public speaking</a>
                </li>
                <li class="nav-item mb-2">
                    <a>Pemberian materi teknik public speaking</a>
                </li>
                <li class="nav-item mb-2"><a>Pembentukakan sikap percaya diri</a></li>
            ...
            <div class="col-md-6">
                ...
                <p class="text-dark">
                    Menguasai dasar-dasar public speaking yang baik dan efisien
                </p>
                <p class="text-dark">Meningkatkan rasa percaya diri</p>
        ...
        <div class="row">
            <div class="col-sm-6 bg-light">
                ...
                <form class="" action="" method="post" autocomplete="off">
                    ...
                    <button class="btn btn-primary mt-2 mb-2" type="submit" name="btn_p1">Submit</button>
                </form>
            </div>
    ...
    <!-- Catatan -->
    <div class="container-fluid">
        <h6 class="text-dark text-uppercase" style="letter-spacing: 8px">
            CATATAN
        </h6>
        <li class="nav-item mb-2">
            <a>Harap mengkonfirmasi pembayaran pendaftaran melalui cp yang tersedia
          di website ini</a
        >
      </li>
      <li class="nav-item mb-2">
        <a
          >Setelah berhasil pendaftaran terkonfirmasi, peserta akan di masukkan
          kedalam grup chat khusus di WhatsApp</a
        >
      </li>
      <li class="nav-item mb-2">
        <a>Informasi lebih lanjut akan disampaikan melalui WhatsApp</a>
        </li>
    </div>
