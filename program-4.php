...
if(isset($_POST["btn_p4"])){
  $nama_lengkap = $_POST["nama_4"];
  $usia = $_POST["usia_4"];
  $alamat = $_POST["alamat_4"];
  $email = $_POST["email_4"];
  $no_telpon = $_POST["notlp_4"];
 

  $query = "INSERT INTO program_4 VALUES('', '$nama_lengkap', '$usia', '$alamat', '$email', '$no_telpon')";
            ...
            <div class="col-sm-6 bg-light">
                ...
                <form class="" action="" method="post" autocomplete="off">
                    <div class="form-group col-md-6">
                        ...
                        <input type="text" class="form-control" name="nama_4" required>
                    </div>
                    <div class="form-group col-md-6">
                        <label for="usia">Usia:</label>
                        <input type="text" class="form-control" name="usia_4" required>
                    </div>
                    <div class="form-group col-md-6">
                        <label for="alamat">Alamat:</label>
                        <input type="text" class="form-control" name="alamat_4" required>
                    </div>
                    <div class="form-group col-md-6">
                        <label for="email">Email:</label>
                        <input type="text" class="form-control" name="email_4" required>
                    </div>
                    <div class="form-group col-md-6">
                        <label for="notelp">No.Telepon:</label>
                        <input type="text" class="form-control" name="notlp_4" required>
                    </div>

                    <button class="btn btn-primary mt-2 mb-2" type="submit" name="btn_p4">Submit</button>
                </form>
            </div>
