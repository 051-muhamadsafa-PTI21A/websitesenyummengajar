...
if(isset($_POST["btn_p3"])){
  $nama_lengkap = $_POST["nama_3"];
  $usia = $_POST["usia_3"];
  $alamat = $_POST["alamat_3"];
  $email = $_POST["email_3"];
  $no_telpon = $_POST["notlp_3"];
 

  $query = "INSERT INTO program_3 VALUES('', '$nama_lengkap', '$usia', '$alamat', '$email', '$no_telpon')";
                ...
                <div class="text-center">
                    <div class="destination-item position-relative overflow-hidden mb-2">
                        <a class="destination-overlay text-dark text-decoration-none" href="">
                            <h5 class="text-dark">Pelatihan Mengajar Bagi Calon Guru</h5>
                            <span>Program ini ditujukan kepada para calon guru yang ingin melatih kesiapan dalam mengajar </span>
    ...
    <div class="container-fluid py-3 border-top">
        <div class="row">
            <div class="col-md-6">
                ...
                <p class="text-dark"> 06-07 Juni 2023</p>
                <p class="text-dark"> Pukul 09.00-12.00 WIB</p>
                <h5 class="bg-primary text-light"> DETAIL AKTIVITAS</h5>
                <li class="nav-item mb-2"><a>Pembekalan materi teknik dasar mengajar</a></li>
                <li class="nav-item mb-2"><a>Mmberikan materi mengenai cara meningkatkan pembelajaran yang efektif</a></li>
                <li class="nav-item mb-2"><a>Memberikan motivasi bagi calon guru</a></li>
                <h5 class="bg-primary text-light"> SYARAT & KETENTUAN</h5>
                <li class="nav-item mb-2"><a>Sehat jasmani dan rohani</a></li>
                <li class="nav-item mb-2"><a>Berusia 20-30 tahun</a></li>
                <li class="nav-item mb-2"><a>Untuk mahasiswa atau calon guru</a></li>
            </div>
            <div class="col-md-6">
                ...
                <p class="text-dark"> Meningkatkan softskill dan hardskill mengajar</p>
            ...
            <div class="col-sm-6 bg-light">
                ...
                <form class="" action="" method="post" autocomplete="off">
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <input type="text" class="form-control" name="usia_3" required>
                    </div>
                    <div class="form-group col-md-6">
                        <label for="alamat">Alamat:</label>
                        <input type="text" class="form-control" name="alamat_3" required>
                    </div>
                    <div class="form-group col-md-6">
                        <label for="email">Email:</label>
                        <input type="text" class="form-control" name="email_3" required>
                    </div>
                    <div class="form-group col-md-6">
                        <label for="notelp">No.Telepon:</label>
                        <input type="text" class="form-control" name="notlp_3" required>
                    </div>

                    <button class="btn btn-primary mt-2 mb-2" type="submit" name="btn_p3">Submit</button>
                </form>
            </div>
