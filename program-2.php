...
if(isset($_POST["btn_p2"])){
  $nama_lengkap = $_POST["nama_2"];
  $usia = $_POST["usia_2"];
  $alamat = $_POST["alamat_2"];
  $email = $_POST["email_2"];
  $no_telpon = $_POST["notlp_2"];
 

  $query = "INSERT INTO program_2 VALUES('', '$nama_lengkap', '$usia', '$alamat', '$email', '$no_telpon')";
                ...
                <div class="text-center">
                    <div class="destination-item position-relative overflow-hidden mb-2">
                        <a class="destination-overlay text-dark text-decoration-none" href="">
                            <h5 class="text-dark">English Class</h5>
                            <span> Program ini adalah program pelatihan bahasa Inggris Pada program ini peserta akan mendapatkan pelajaran mengenai grammar dasar, listening test dan reading test.</span>
                        </a>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-sm-6 bg-light">
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <input type="text" class="form-control" name="usia_2" required>
                    </div>
                    <div class="form-group col-md-6">
                        <label for="alamat">Alamat:</label>
                        <input type="text" class="form-control" name="alamat_2" required>
                    </div>
                    <div class="form-group col-md-6">
                        <label for="email">Email:</label>
                        <input type="text" class="form-control" name="email_2" required>
                    </div>
                    <div class="form-group col-md-6">
                        <label for="notelp">No.Telepon:</label>
                        <input type="text" class="form-control" name="notlp_2" required>
                    </div>

                    <button class="btn btn-primary mt-2 mb-2" type="submit" name="btn_p2">Submit</button>
                </form>
                </div>
                <div class="col-sm-6 bg-default">
                    <h5 class="text-light bg-primary">PEMBAYARAN</h5>
                    <p class="text-dark"> Rp.650.000/Orang</p>
                    ...
                    <P class="text-dark"> *Jumlah diatas sudah termasuk:
                        ...
                        <li class="nav-item mb-2"><a>Hadiah perlombaan</a></li>
                    </P>
                </div>
            </div>
        </div>
