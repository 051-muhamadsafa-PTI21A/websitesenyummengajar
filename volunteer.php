    ...
    <div class="container-fluid p-1">
        <div class="container pt-5 pb-3">
            <div class="text-center mb-3 pb-3">
                ...
                <h1 class="text-primary " style="letter-spacing: 5px;">Kegiatan Pengajaran</h1>
            </div>
                ...
                <div class="col-lg-4 col-md-6 mb-4">
                    <div class="card text-light bg-white pb-2">
                        <div class="card-body text-dark">
                            ...
                            <h3 class="card-tittle">Volunteer Live in 3j</h3>
                            <p class="lead">Kegiatan pengajaran dan volunteer pendidikan, memberikan kesempatan bagi adik adik dipelosok desa untuk merasakan pendi...
                            </p>
                            <a class="btn bg-primary text-white" href="volunteer-1.php">Selengkapnya</a>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6 mb-4">
                    <div class="card text-light bg-white pb-2">
                        <div class="card-body text-dark">
                            ...
                            <h3 class="card-tittle">Peneleh Youth Volunteer Camp</h3>
                            <p class="lead">Mari berkonribusi terhadap pengajaran dan pendidikan anak-anak dipelosok desa yang memiliki akses terbatas, ter...
                            </p>
                            </p>
                            <a class="btn bg-primary text-white" href="volunteer-2.php">Selengkapnya</a>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6 mb-4">
                    <div class="card text-light bg-white pb-2">
                        <div class="card-body text-dark">
                            ...
                            <h3 class="card-tittle">Kelas Literasi</h3>
                            <p class="lead">Ayo berkontribusi terhadap cakap literasi dan pembelajaran terkait dengan pemahaman bcaaan buku, dongeng, fab...
                            </p>
                            </p>
                            <a class="btn bg-primary text-white" href="volunteer-3.php">Selengkapnya</a>
                        </div>
                    </div>
                </div>
            </div>
